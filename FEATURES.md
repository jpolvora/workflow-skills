...
| **Script runtime policy** | Node 22 is the unique packaged skill/installer/test runtime. Managed scripts are Node `.cjs` only; no `.py` is shipped. Shared `http_retry.cjs` retries 429/5xx |
