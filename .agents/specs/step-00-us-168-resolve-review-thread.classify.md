...
classifiedAt: 2026-07-29T21:50:39.499Z
scoreAndRefine: false
---

# Pipeline Classification — fix(ws-goal-fix-pr): execute resolveReviewThread GraphQL mutation after posting thread fix replies
...
| Estimated files (path refs) | 1 | 6 | yes |
| Layers | 3 | 2 | no |
| Sections | 3 | — | — |
