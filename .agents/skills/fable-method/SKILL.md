...
/fable-method plan <task>  Steps 0–3 only → plan → STOP for approval
/fable-method audit        Audit via fable-judge
/fable-method report       Outcome-first report with caveats
```
...
- Recurring domain → `fable-domain` adapter
