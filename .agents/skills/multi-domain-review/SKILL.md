...
1. Slugs from `specs/domains/index.md` § Index **main table only** (not Subdomains). If the file is missing, **STOP** (consumer must add the catalog — starter: [`index.md.example`](../../../specs/domains/index.md.example)).
