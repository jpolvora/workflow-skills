...
1. **BOOTSTRAP** section in [`setup.md`](../ws-shared/runtime/setup.md) — ensure `.ws/config.json` points at this repo. If absent, create one:
...
|---------|-------------|-----|
| `.ws/config.json` not found | Config not in project hub | Create minimal config (see prerequisites) |
