...
# Keep in sync with the lite copy and with STATE_VERSION in workflow_state.cjs.
_STATE_VERSION = 2
...
def main():
    ensure_utf8_stdio()
    parser = argparse.ArgumentParser(description="Update ws-spec-to-pr state.md frontmatter")
