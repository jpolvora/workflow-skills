...
Gate options for Phase B (folded into the Step 8 combined gate close phase, or Separate gates / Pause legacy close menu, in [`gates.md`](../../ws-shared/runtime/gates.md)):
