...
3. **Clean-immediate** — fresh read already clean on entry → write the `round-0-clean-immediate` marker, then exit without arming a heartbeat (step 2).
