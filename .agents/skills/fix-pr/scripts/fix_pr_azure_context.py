...
Uso:
  python .agents/skills/fix-pr/scripts/fix_pr_azure_context.py collect --pr-id 592 --output .agents/skills/fix-pr/runs/pr-592/context.json
  python .agents/skills/fix-pr/scripts/fix_pr_azure_context.py resolve-thread --pr-id 592 --thread-id 4001 --comment "Justificativa..."
  python .agents/skills/fix-pr/scripts/fix_pr_azure_context.py resolve-thread --dry-run --pr-id 592 --thread-id 4001 --comment "Justificativa..."
"""
