...
Reiterate strict architectural invariants from config.json.invariants and project stack rule pack ({skillsRoot}/ws-shared/runtime/stacks/{stack}.md). Explicitly identify touched framework boundaries:
