...
Usage:
  python .agents/skills/ws-spec-provider-azure-devops/scripts/fix_pr_azure_context.py collect --pr-id 592 --output .agents/skills/ws-fix-pr/runs/pr-592/context.json
  python .agents/skills/ws-spec-provider-azure-devops/scripts/fix_pr_azure_context.py resolve-thread --pr-id 592 --thread-id 4001 --model composer-2.5 --comment "loadList() now preloads row actions so Edit is visible before the extra-actions menu. Fixed in 3dc20274."
  python .agents/skills/ws-spec-provider-azure-devops/scripts/fix_pr_azure_context.py resolve-thread --dry-run --pr-id 592 --thread-id 4001 --model composer-2.5 --comment "loadList() now preloads row actions so Edit is visible before the extra-actions menu. Fixed in 3dc20274."
"""
