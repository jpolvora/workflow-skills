...
Do **not** call tracker APIs. Validate required sections per [`spec-format`](../spec-to-pr/extra-skills/spec-format/SKILL.md) after registration when running as an agent.
