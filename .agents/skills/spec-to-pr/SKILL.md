...
5. Optional `config.json.fable.enabled` → [`fable-domain`](../fable-domain/SKILL.md) (Step 1), [`fable-judge`](../fable-judge/SKILL.md) (Steps 5/6/8).
