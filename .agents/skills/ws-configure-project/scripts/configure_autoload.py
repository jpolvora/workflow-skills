...
SHARED_CONFIG_EXAMPLE_REL = (
    Path(".agents") / "skills" / "ws-shared" / "templates" / "config.json.example"
)
SHARED_AUTOLOAD_REL = Path(".agents") / "skills" / "ws-shared" / "autoload.md"
SHARED_RUNTIME_REL = Path(".agents") / "skills" / "ws-shared" / "runtime"
