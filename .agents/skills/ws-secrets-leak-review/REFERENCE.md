...
- **Optional script:** `node .agents/skills/ws-secrets-leak-review/scripts/secrets_scanner.cjs` is for pre-commit / manual CLI. It uses ignore-aware globs and caps hits (`SECRETS_SCAN_MAX_HITS`, default 50).
