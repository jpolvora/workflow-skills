...
> **Scope note:** Full upstream inventory. Membership is [`../../../bin/skill-dependencies.json`](../../../bin/skill-dependencies.json) (`workflows` = 43, `extra` = 8). Extra rows are absent from Workflows-only installs. Consumer routes: [`AGENTS.md`](AGENTS.md).
>
