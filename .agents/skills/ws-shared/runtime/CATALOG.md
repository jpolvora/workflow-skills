...
| `ws-wiki` | `.agents/skills/ws-wiki/SKILL.md` | Living project feature wiki & domain knowledge base manager (init, sync, sweep, Phase 2 wiki-vs-code verify and Phase 3 plan/apply) |
