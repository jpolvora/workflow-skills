...
- [ ] **1. Run Tests & Verification**: Execute `verification.backendTest` / `verification.frontendTest` and the stack invariant scan (`node {sharedDir}/runtime/scripts/scan_stack_invariants.cjs`).
