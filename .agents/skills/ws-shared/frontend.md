# Frontend Patterns & UI/UX Preferences
...
- **Rule**: Short summary of the frontend UI/UX requirement.
- **Context/Rationale**: Why this preference was established.
- **Example / UI Pattern**: Standard pattern, styling rule, or component structure to follow.
-->
