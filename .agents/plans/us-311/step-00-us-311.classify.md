...
classifiedAt: 2026-09-11T03:43:17.133Z
scoreAndRefine: false
---

# Pipeline Classification — Stamp finished step artifacts with the step result, not the overall workflow status
...
| estimatedElapsedSec | `833` | Sourced from completed-run telemetry median. |
