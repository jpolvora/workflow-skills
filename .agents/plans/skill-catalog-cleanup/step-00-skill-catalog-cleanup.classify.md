...
classifiedAt: 2026-08-22T20:43:36.980Z
scoreAndRefine: false
---

# Pipeline Classification — Skill catalog cleanup: Extra demotion and patterns merge
...
| estimatedElapsedSec | `802.5` | Sourced from completed-run telemetry median. |
