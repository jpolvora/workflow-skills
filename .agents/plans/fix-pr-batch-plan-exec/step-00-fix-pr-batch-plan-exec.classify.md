...
classifiedAt: 2026-08-25T16:41:16.923Z
scoreAndRefine: false
---

# Pipeline Classification — fix-pr: plan substep (reviewer model) then execute (fix model) per batch
...
| estimatedElapsedSec | `288` | Sourced from completed-run telemetry median. |

## Metrics

| Metric | Count | Threshold | Within |
|--------|-------|-----------|--------|
| Implementation steps (ACs) | 13 | 3 | no |
...
`choice: accept` (autoMode + user set full auto)  
`classifiedAtChoice: 2026-08-25T16:43:00Z`
