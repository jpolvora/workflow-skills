...
classifiedAt: 2026-09-13T01:45:56.927Z
scoreAndRefine: false
---

# Pipeline Classification — ws-wiki: verbosity/prose-style option + richer conditional page template
...
|--------|-------|-----------|--------|
| Implementation steps (ACs) | 14 | 3 | no |
| Estimated files (path refs) | 24 | 6 | no |
| Layers | 3 | 2 | no |
| Sections | 8 | — | — |
