...
workflowId: us-369
status: completed
startedAt: "2026-09-20T04:44:54.149Z"
endedAt: "2026-09-20T04:44:54.149Z"
acRefs: []
---
...
- Enhanced from converter output during ws-spec-from-provider import (GitHub).
...
| Atomic acceptance criteria | AC1–AC6 each independently checkable (unit cases, green-run gate, validator) | `validate_spec.cjs --mode=authoring` passes |
