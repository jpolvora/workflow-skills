...
runInterview: true
classifiedAt: 2026-09-19T23:26:05.080Z
scoreAndRefine: false
---

# Pipeline Classification — Unique Node runtime for all workflow-skills helper scripts
...
|--------|-------|-----------|--------|
| Implementation steps (ACs) | 26 | 3 | no |
| Estimated files (path refs) | 84 | 6 | no |
