...
classifiedAt: 2026-09-03T13:13:37.424Z
scoreAndRefine: false
---

# Pipeline Classification — Download tracker images and attachments during fetch-to-spec (GitHub and Azure DevOps parity)
...
|--------|-------|-----------|--------|
| Implementation steps (ACs) | 28 | 3 | no |
