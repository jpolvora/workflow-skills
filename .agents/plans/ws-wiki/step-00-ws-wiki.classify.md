...
classifiedAt: 2026-09-12T04:33:23.596Z
scoreAndRefine: false
---

# Pipeline Classification — ws-wiki: living project feature wiki and domain knowledge base manager
...
|--------|-------|-----------|--------|
| Implementation steps (ACs) | 18 | 3 | no |
| Estimated files (path refs) | 28 | 6 | no |
| Layers | 3 | 2 | no |
| Sections | 7 | — | — |
