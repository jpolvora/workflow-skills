...
runInterview: true
classifiedAt: 2026-09-17T01:21:38.158Z
scoreAndRefine: false
---

# Pipeline Classification — Optional ws-preview dry-run gate in ws-ship-pr before Create PR
...
| Estimated files (path refs) | 13 | 6 | no |
...
**Outcome (2026-09-17T01:22Z):** user selected **Override to lite** → `finalPipeline: lite` (recommended was `standard`; lite run continues; implementation already exists uncommitted).
