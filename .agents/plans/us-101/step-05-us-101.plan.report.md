...
|------|-------------|--------|----------|
| AC1 | Fix relative links in managed skill docs | ✅ PASS | Links updated in `gabarito/README.md`, `ws-ship-pr/PREPARE-CHECKLIST.md`, `shared/setup.md`, `spec-to-pr/README.md` |
