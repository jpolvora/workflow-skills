...
1. Fix relative links in managed skill docs pointing to root `AGENTS.md` sections (`../../../AGENTS.md`) so they point to `ws-shared/AGENTS.md` (or same-directory `AGENTS.md` in `ws-shared/setup.md`).
2. Split delivery checklist in `ws-shared/AGENTS.md` into **Upstream maintainers (workflow-skills)** and **Consumer projects**.
3. Update `check-harness/SKILL.md` Phase 4 prose to cite the resolved hub (`ws-shared/AGENTS.md` in consumer mode) instead of assuming root `AGENTS.md`.
...
- AC1: `gabarito/README.md`, `ws-ship-pr/PREPARE-CHECKLIST.md`, `ws-shared/setup.md`, `spec-to-pr/README.md` have updated relative link targets pointing to `ws-shared/AGENTS.md`.
- AC2: `ws-shared/AGENTS.md` delivery checklist clearly demarcates upstream-only commands (`npm run build-site:bump`, `generate-integrity`, `verify-integrity`) from consumer verification.
...
1. **Fix Consumer-facing Managed Doc Links**:
   - `gabarito/README.md`: replace `../../../AGENTS.md` with `../ws-shared/AGENTS.md`.
   - `ws-ship-pr/PREPARE-CHECKLIST.md`: replace `../../../AGENTS.md#external-dependencies` with `../ws-shared/AGENTS.md#external-dependencies`.
   - `ws-shared/setup.md`: replace `../../../AGENTS.md#external-dependencies` with `AGENTS.md#external-dependencies`.
   - `spec-to-pr/README.md`: replace `../../../AGENTS.md` link with `../ws-shared/AGENTS.md`.
2. **Update `ws-shared/AGENTS.md` Delivery Checklist**:
...
3. **Update `check-harness/SKILL.md`**:
   - Update Phase 4 prose to refer to the resolved hub (e.g. `ws-shared/AGENTS.md` in consumer mode).
...
## 5. Test Coverage
- AC1: File search for `../../../AGENTS.md` in managed skills ensures consumer-facing docs point to `ws-shared/AGENTS.md`.
- AC2: Inspect `ws-shared/AGENTS.md` checklist section.
