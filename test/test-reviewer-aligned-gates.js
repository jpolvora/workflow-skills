...
try {
  ...
  fs.mkdirSync(path.join(ledgerTmp, '.ws'), { recursive: true });
  fs.writeFileSync(path.join(ledgerTmp, '.ws', 'config.json'), JSON.stringify({
    verification: {},
  ...
  fs.mkdirSync(path.join(abpProj, '.ws', 'templates'), { recursive: true });
  fs.mkdirSync(path.join(abpProj, '.ws', 'runtime'), { recursive: true });
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'templates', 'config.json.example'), path.join(abpProj, '.ws', 'templates', 'config.json.example'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'config.schema.json'), path.join(abpProj, '.ws', 'runtime', 'config.schema.json'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'hub-layout.json'), path.join(abpProj, '.ws', 'runtime', 'hub-layout.json'));
  ...
  assert(!fs.existsSync(path.join(abpProj, '.ws', 'MEMORY.md')), 'no legacy hub MEMORY.md written');
  ...
  fs.mkdirSync(path.join(nextProj, '.ws', 'templates'), { recursive: true });
  fs.mkdirSync(path.join(nextProj, '.ws', 'runtime'), { recursive: true });
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'templates', 'config.json.example'), path.join(nextProj, '.ws', 'templates', 'config.json.example'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'config.schema.json'), path.join(nextProj, '.ws', 'runtime', 'config.schema.json'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'hub-layout.json'), path.join(nextProj, '.ws', 'runtime', 'hub-layout.json'));
  ...
  fs.mkdirSync(path.join(phpProj, '.ws', 'templates'), { recursive: true });
  fs.mkdirSync(path.join(phpProj, '.ws', 'runtime'), { recursive: true });
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'templates', 'config.json.example'), path.join(phpProj, '.ws', 'templates', 'config.json.example'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'config.schema.json'), path.join(phpProj, '.ws', 'runtime', 'config.schema.json'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'hub-layout.json'), path.join(phpProj, '.ws', 'runtime', 'hub-layout.json'));
  ...
  fs.mkdirSync(path.join(tsProj, '.ws', 'templates'), { recursive: true });
  fs.mkdirSync(path.join(tsProj, '.ws', 'runtime'), { recursive: true });
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'templates', 'config.json.example'), path.join(tsProj, '.ws', 'templates', 'config.json.example'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'config.schema.json'), path.join(tsProj, '.ws', 'runtime', 'config.schema.json'));
  fs.copyFileSync(path.join(REPO_ROOT, '.agents', 'skills', 'ws-shared', 'runtime', 'hub-layout.json'), path.join(tsProj, '.ws', 'runtime', 'hub-layout.json'));
