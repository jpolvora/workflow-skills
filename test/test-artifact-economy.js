...
const faq = fs.readFileSync(path.join(repoRoot, '.agents/skills/ws-spec-to-pr/docs/faq.md'), 'utf8');
assert.match(faq, /plan\.index\.json is required before implement/);
assert.match(faq, /plan_index\.cjs build/);
assert.match(faq, /ac-ledger\.json is required before advance/);
