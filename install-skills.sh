...
echo "  Consumer-owned under .agents/skills/ws-shared/:"
...
echo "  Managed hub content: ws-shared/runtime/ + ws-shared/templates/ (manifest-driven)"
echo "  Path tokens: config pathTokens + ws-shared/runtime/tools.md ({skillsRoot}/{sharedDir}/{plansDir})"
