...
| **Dual-path specs** | Both `{specsDir}/{slug}.spec.md` mirror and `{plansDir}/{slug}/step-00-*.spec.md` exist | `{specsDir}/{slug}.spec.md` path is primary for index status updates. |
