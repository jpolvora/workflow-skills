...
- **On-demand:** [`../ws-spec-to-pr/SKILL.md`](../ws-spec-to-pr/SKILL.md) · [`../ws-spec-to-pr-lite/SKILL.md`](../ws-spec-to-pr-lite/SKILL.md) · [`../ws-ship-pr/SKILL.md`](../ws-ship-pr/SKILL.md) · [`../ws-goal-fix-pr/SKILL.md`](../ws-goal-fix-pr/SKILL.md) · [`../ws-shared/tools.md`](../ws-shared/tools.md). Language: **en-us** only.
...
2. **Base Branch Sync:** Record `baseBranch` in state file header. Before worker dispatch and after PR merge success, fetch & pull `baseBranch` (`git merge {baseBranch}` / `git rebase {baseBranch}`).
