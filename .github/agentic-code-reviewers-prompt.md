...
* **Skill structure:** `SKILL.md` frontmatter must keep a unique `name:`. Paths referenced from hubs (root `AGENTS.md`, `.ws/AGENTS.md`) must match real folders under `.agents/skills/`.
