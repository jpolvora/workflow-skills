...
| [`ws-spec-memo`](.agents/skills/ws-spec-memo/SKILL.md) | Bridge to [spec-memo](https://github.com/jpolvora/spec-memo) external vault (MCP/CLI); migrate in-repo MEMORY/plans off product git |
