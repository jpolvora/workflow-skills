...
| [`ws-spec-memo`](.agents/skills/ws-spec-memo/SKILL.md) | Bridge to [spec-memo](https://github.com/jpolvora/spec-memo) external vault (MCP/CLI); dual memory routing (`enableMemoryFiles` / `enableSpecMemoIntegration`), setup & legacy migration |
