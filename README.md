...
| **[`ws-multi-spec`](.agents/skills/ws-multi-spec/SKILL.md)** | Smart batch delivery | Sequential multi-spec queue execution with smart flow auto-detection (`spec-to-pr` vs `spec-to-pr-lite` per spec complexity) |
