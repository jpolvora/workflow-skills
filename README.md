...
| **[`ws-long-runner`](.agents/skills/ws-long-runner/SKILL.md)** | Batch delivery | Sequential multi-spec queue execution (reads queue → probes → dispatches `spec-to-pr` workers) |
