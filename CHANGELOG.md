...
- **Prompt**: Improve/enhance artifacts naming for each step of us-workflow with step prefixes, translate legacy Portuguese to English, and improve project portability.
