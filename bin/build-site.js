...
`<section id="catalog">
  ...
  <div class="catalog-controls">
    ...
    <div class="filter-pills" id="filter-pills">
      ...
      <button type="button" class="filter-pill" data-filter="layer-1">Layer 1 (Specs)</button>
      <button type="button" class="filter-pill" data-filter="layer-2">Layer 2 (Pipeline)</button>
      <button type="button" class="filter-pill" data-filter="layer-3">Layer 3 (Providers)</button>
