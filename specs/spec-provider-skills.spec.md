...
1. **Inbound work items** — pull GitHub issues, Azure DevOps work items / user stories, or hand-written local markdown specs into the canonical `{us-dir}/step-00-{slug}.spec.md` artifact ([spec-format](../.agents/skills/spec-format/SKILL.md)).
